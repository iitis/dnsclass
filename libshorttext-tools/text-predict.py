...
options:
    ...
    -a {0|1}
        ...
        0   Store only predicted labels. The information is NOT sufficient 
            for interactive analysis. Use this option if you would like to get only accuracy.
...
if __name__ == '__main__':
	...
	m = TextModel()
	m.load(model)
	predict_result = predict_text(data, m, svm_file=None, predict_arguments = liblinear_arguments)
